#!/usr/bin/env python3
"""Generate and submit the final RuModernBERT full-human run."""
...
import create_rumodernbert_3ep_full_human_notebook as builder
import run_kaggle_notebook as kaggle


ROOT = Path(__file__).resolve().parents[1]
DEFAULT_SLUG = "product-matching-rumodernbert-3ep-full-human-final"
DEFAULT_TITLE = "Product Matching RuModernBERT 3ep Full Human Final"
